...
class CafeteriaApp:
    def __init__(self, root):
        ...
        self.inventario = cafeteriaback.Inventario()
    ...
    def mostrar_pantalla_inicio(self):
        ...
        try:
            logo = Image.open("c://Users//CATASTRO MUNICIPAL 1//Downloads//proyectocafeteria//cafeteria-en-puebla.jpg").resize((600, 400))
    ...
    def mostrar_menu_cliente(self):
        for widget in self.root.winfo_children():
            widget.destroy()
        try:
            cliente_img = Image.open("c://Users//CATASTRO MUNICIPAL 1//Downloads//proyectocafeteria//images (1)22.jfif").resize((200, 80))
            ...
            print("Error: No se encontró la imagen del menú de cliente.")
    ...
    def mostrar_menu_empleado(self):
        for widget in self.root.winfo_children():
            widget.destroy()
        try:
            empleado_img = Image.open("c://Users//CATASTRO MUNICIPAL 1//Downloads//proyectocafeteria//cafeteria-en-puebla.jpg").resize((200, 80))
            ...
            print("Error: No se encontró la imagen del menú de empleado.")
